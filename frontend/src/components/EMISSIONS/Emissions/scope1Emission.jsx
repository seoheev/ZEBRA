...
/** Scope1Emission — 스코프1 전용 탭 */
export default function Scope1Emission({ fetchEmissions, onExport, permissions }) {
    ...
    <div style={styles.wrap}>
      <div style={styles.headerRow}>
        <div style={styles.titleArea}>
          <h3 style={styles.title}>Scope 1 배출량</h3>
          <div style={styles.sub}>연료 연소/차량 등 직접배출</div>
        </div>
      ...
      <div style={styles.panel}>
        ...
        <div style={styles.placeholder}>여기에 Scope1 차트</div>
      </div>
      ...
      <div style={styles.panel}>
        ...
        {error ? (
          ...
          <div style={styles.placeholder}>여기에 Scope1 테이블</div>
        ) : (
