...
export default function Graph4({
  series,                      // [{date:'YYYY-MM' 또는 'YYYY', value:number}, ...] (scope1 총배출)
  unitLabel = "kgCO₂e",
}) {
  // 이전 연도 더미(원하면 값만 조정)
  ...
  // 입력 series를 연도 합계로 집계 + 필요시 더미 병합
  ...
  return (
    <div style={card}>
      <p style={TITLE_STYLE}>연도별 탄소 배출 (Scope 1)</p>
