    ...
    <div style={card}>
      ...
      <div style={layout}>
        ...
        <div style={controls}>
          ...
          <label style={radio}>
            <input type="radio" name="gran" value="month" checked={granularity === "month"} onChange={() => setGranularity("month")} />
            개월
          </label>
          <label style={radio}>
            <input type="radio" name="gran" value="year" checked={granularity === "year"} onChange={() => setGranularity("year")} />
            연
          </label>
        </div>
      </div>
